namespace assignment3
{
	partial class Form1
	{
		...
		private void InitializeComponent()
		{
			...
			this.label1.Text = "Input for Table";
			// 
			// label2
			// 
			...
			this.label2.Text = "Input sleep Time";
			// 
			// label3
			// 
			...
			// textBox2
			// 
			this.textBox2.Location = new System.Drawing.Point(370, 79);
			...
			this.listBox1.Location = new System.Drawing.Point(94, 177);
